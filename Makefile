...
CXX      =  mpiicpc
FC	 =  mpiicc
OPTIMIZE = -O1 #-w2  -funroll-loops -fopenmp 
OPTIMIZE += #-fopenmp  #-parallel -qopenmp # openmp required compiler flags-fopenmp #
GMP_INCL = #
GMP_LIBS = #
MKL_INCL = #-I$(MKL_HOME)/include
MKL_LIBS = # -lm -lmkl_core -lmkl_sequential -lmkl_scalapack_lp64 -lmkl_intel_lp64 -lmkl_blacs_intelmpi_lp64
GSL_INCL = -I/sh2/software/mathlib/gsl/2.7.1-intel2022/gsl/include
GSL_LIBS = -L/sh2/software/mathlib/gsl/2.7.1-intel2022/gsl/lib
FFTW_INCL= #-I/share/home/hpdeng/mysoft/include
FFTW_LIBS= #-L/share/home/hpdeng/mysoft/lib
HDF5INCL =  -I/sh2/software/mathlib/hdf5/1.12.2_intel/hdf5/include -DH5_USE_16_API 
HDF5LIB  =  -L/sh2/software/mathlib/hdf5/1.12.2_intel/hdf5/lib -lhdf5  -L/sh2/software/mathlib/zlib/1.2.12/lib -lz
MPICHLIB = -L/sh2/software/compiler/intel/oneapi_2022.2/mpi/2021.6.0/libfabric/lib
OPT     += -DUSE_MPI_IN_PLACE  
## modules to load: 
## module load intel/2011.4.191 impi/4.0.2.003 gsl/1.15-gcc HDF5 
##  -- the machine is quite picky, impi seems to be the only working mpi option right now
...
OPTIMIZE += #-Wall  #-fopenmp #-parallel -qopenmp # openmp required compiler flags-fopenmp #
GMP_INCL = #
GMP_LIBS = #
MKL_INCL = #-I$(MKL_HOME)/include
MKL_LIBS = # -lm -lmkl_core -lmkl_sequential -lmkl_scalapack_lp64 -lmkl_intel_lp64 -lmkl_blacs_intelmpi_lp64
GSL_INCL = #-I/users/hpdeng/mysoft/gsl-2.3/include
GSL_LIBS = #-L/users/hpdeng/mysoft/gsl-2.3/lib
FFTW_INCL= #-I/usr/include
FFTW_LIBS= #-L/usr/lib64
HDF5INCL =  -DH5_USE_16_API
HDF5LIB  =  -lhdf5 -lz
MPICHLIB = #-L/usr/lib64/mpich2/lib
...
ifeq (EOS_TILLOTSON,$(findstring EOS_TILLOTSON,$(CONFIGVARS)))
OBJS    += tillotson/tillotson.o tillotson/tillinitlookup.o tillotson/tillsplint.o tillotson/interpol/coeff.o tillotson/interpol/interpol.o tillotson/interpol/brent.o tillotson/nr/nrcubicspline.o tillotson/nr/nrutil.o
INCL	+= tillotson/tillotson.h
endif

ifeq (EOS_ANEOS,$(findstring EOS_ANEOS,$(CONFIGVARS)))
OBJS	+= aneos/eos_table.o
INCL	+= aneos/eos_table.h
endif
