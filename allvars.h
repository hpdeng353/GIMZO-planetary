...
#ifndef SHEARING_BOX_OMEGA_BOX_CENTER 
...
#ifdef ANALYTIC_STAR
  double Analytic_Mass,Analytic_Soft;
...
#ifdef PLANETAC
ALIGN(32) MyDouble PLANETPos[3];
int PLANETTask;
MyDouble Dist2PLANET;
#endif // PLANETAC
...
extern struct sph_particle_data
{
    ...
    MyDouble BPred[3];              /*!< current magnetic field strength can be flux*/
