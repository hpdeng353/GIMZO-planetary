...
LONG_X=100                     # modify box dimensions (non-square periodic box): multiply X (PERIODIC and NOGRAVITY required)
LONG_Y=100                       # modify box dimensions (non-square periodic box): multiply Y
LONG_Z=100                       # modify box dimensions (non-square periodic box): multiply Z
...
SHEARING_BOX=4                 # shearing box boundaries: 1=r-z sheet (r,z,phi coordinates), 2=r-phi sheet (r,phi,z), 3=r-phi-z box, 4=as 3, with vertical gravity
SHEARING_BOX_OMEGA_BOX_CENTER=
