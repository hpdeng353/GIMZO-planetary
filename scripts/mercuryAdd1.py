...
deltax=-8.5 #(rr+rr1)*1.02*np.sqrt(1.-b*b) + (rr+rr1)*4.
deltay=11.83#-(rr+rr1)*1.05
...
deltav=0.5859#np.sqrt(1.12/(rr+rr1))*11.18*(1.05-0.)#1./np.sqrt(deltay*deltay + deltax*deltax))
deltavy=8.453
#deltav=9.2*1.15
vv= deltav*gamma
vv1= -deltav*(1-gamma)
