...
deltax=-4.5 #(rr+rr1)*1.02*np.sqrt(1.-b*b) + (rr+rr1)*4.
deltay=17.05#-(rr+rr1)*1.05
...
deltav=1.006#np.sqrt(1.12/(rr+rr1))*11.18*(1.05-0.)#1./np.sqrt(deltay*deltay + deltax*deltax))
deltavy=8.33
#deltav=9.2*1.15
vv= deltav*gamma
vv1= -deltav*(1-gamma)
