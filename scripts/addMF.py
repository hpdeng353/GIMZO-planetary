...
s = h5py.File('/scratch/snx3000/hpdeng/gizmout/boxtest1/init/boxtest1-ics.hdf5','r+')
...
mag[:,1] = 0 #np.sqrt(2*P0/betay)# - 2*P0/betap*np.sin(np.pi*rr/R0)*np.sin(np.pi*rr/R0))
mag[:,0]= 0
mag[:,2]= 0
"""
...
s.create_dataset("PartType0/Velocities",data=mag)
