...
void Riemann_solver(struct Input_vec_Riemann Riemann_vec, struct Riemann_outputs *Riemann_out, double n_unit[3], double press_tot_limiter)
{
    ...
    Riemann_vec1.L.cs = sqrt(GAMMA * Riemann_vec1.L.p / Riemann_vec1.L.rho);
    Riemann_vec1.R.cs = sqrt(GAMMA * Riemann_vec1.R.p / Riemann_vec1.R.rho);
    Riemann_vec1.L.u  = Riemann_vec1.L.p / (GAMMA_MINUS1 * Riemann_vec1.L.rho);
    Riemann_vec1.R.u  = Riemann_vec1.R.p / (GAMMA_MINUS1 * Riemann_vec1.R.rho);
#endif
    ...
    Riemann_out->Fluxes.v[0]=0;
    Riemann_out->Fluxes.v[1]=0;
    Riemann_out->Fluxes.v[2]=0;
    Riemann_out->Fluxes.rho=0;
    Riemann_out->Fluxes.p=0;
    Riemann_out->S_M=0;
    Riemann_out->P_M=0;
    ...
    double cs_L = Riemann_vec1.L.cs;
    double cs_R = Riemann_vec1.R.cs;
    double h_L = Riemann_vec1.L.p/Riemann_vec1.L.rho + Riemann_vec1.L.u + 0.5*(Riemann_vec1.L.v[0]*Riemann_vec1.L.v[0]+Riemann_vec1.L.v[1]*Riemann_vec1.L.v[1]+Riemann_vec1.L.v[2]*Riemann_vec1.L.v[2]);
    double h_R = Riemann_vec1.R.p/Riemann_vec1.R.rho + Riemann_vec1.R.u + 0.5*(Riemann_vec1.R.v[0]*Riemann_vec1.R.v[0]+Riemann_vec1.R.v[1]*Riemann_vec1.R.v[1]+Riemann_vec1.R.v[2]*Riemann_vec1.R.v[2]);
    double v_line_L = Riemann_vec1.L.v[0]*n_unit[0] + Riemann_vec1.L.v[1]*n_unit[1] + Riemann_vec1.L.v[2]*n_unit[2];
    double v_line_R = Riemann_vec1.R.v[0]*n_unit[0] + Riemann_vec1.R.v[1]*n_unit[1] + Riemann_vec1.R.v[2]*n_unit[2];
    
    
    HLLC_Riemann_solver(Riemann_vec1, Riemann_out, n_unit, v_line_L, v_line_R, cs_L, cs_R, h_L, h_R, press_tot_limiter);
    if((Riemann_out->P_M<=0)||(isnan(Riemann_out->P_M)))
        Riemann_solver_Rusanov(Riemann_vec1, Riemann_out, n_unit, v_line_L, v_line_R, cs_L, cs_R, h_L, h_R);
...
void HLLD_Riemann_solver(struct Input_vec_Riemann Riemann_vec, struct Riemann_outputs *Riemann_out, double press_tot_limiter)
{
    ...
    if(within_sampled_vacuum == 1)
    {
        ...
        P_M = MIN_REAL_NUMBER; S_M = v_frame = Riemann_out->B_normal_corrected = Riemann_out->phi_normal_mean = Riemann_out->phi_normal_db = 0; // vanish<ing //
